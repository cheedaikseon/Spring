          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="../board/listAll"><i class="fa fa-circle-o"></i> 전체 게시글</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="../board/listCri"><i class="fa fa-circle-o"></i> CRI 처리</a></li>
                <li><a href="../board/listPage"><i class="fa fa-circle-o"></i> PAGING</a></li>
                <li><a href="../sboard/list"><i class="fa fa-circle-o"></i> FOUND </a></li>
              </ul>
            </li>
            <li>
              <a href="../widgets.html">
